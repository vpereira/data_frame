...
VERS = DataFrame::VERSION::STRING + (REV ? ".#{REV}" : "")
RDOC_OPTS = ['--quiet', '--title', 'data_frame documentation',
    "--opname", "index.html",
    "--line-numbers", 
    "--main", "README",
    "--inline-source"]
...
hoe = Hoe.new(GEM_NAME, VERS) do |p|
  ...
  p.extra_deps = ['fastercsv', 'facets']     # An array of rubygem dependencies [name, version], e.g. [ ['active_support', '>= 1.3.1'] ]
